...
protected:
	...
	//UFUNCTION(Client, unreliable, Category = "Chat|Display")
	//virtual void Client_AddChatConstantData(EChatColor Color, EMessageCategories Category, int32 MessageId) override;
	//UFUNCTION(Client, unreliable, Category = "Chat|Display")
	//virtual void Client_AddChatConstantWithVariablesData(EChatColor Color, EMessageCategories Category, int32 MessageId, const TArray<FString>& Variables) override;

	// These are from IPlayerChatInterface
	virtual void Client_AddChatConstantData(EChatColor Color, EMessageCategories Category, int32 MessageID) override;
	virtual void Client_AddChatConstantWithVariablesData(EChatColor Color, EMessageCategories Category, int32 MessageID, const TArray<FString>& Variables) override;
